  ...
  setup() {
    ...
    return () => {
      ...
      return (
        <div class="space-y-5">
          <div
            class="rounded-2xl p-5 shadow-sm flex flex-wrap gap-4 items-end justify-between"
            style={{
              background: "#fff",
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  <input
                    ...
                    value={desde.value}
                    onChange={(e) =>
                      (desde.value = (e.target as HTMLInputElement).value)
                    }
                    class="pl-9 pr-3 py-2.5 rounded-xl text-sm outline-none"
                    style={{
                      background: "#F8FAFC",
              ...
              <div>
                ...
                <div class="relative">
                  ...
                  <input
                    ...
                    value={hasta.value}
                    onChange={(e) =>
                      (hasta.value = (e.target as HTMLInputElement).value)
                    }
                    class="pl-9 pr-3 py-2.5 rounded-xl text-sm outline-none"
                    style={{
                      background: "#F8FAFC",
          ...
          <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              },
              {
                ...
                value: unidades.toLocaleString("es-HN"),
                icon: Package,
                color: "#86EFAC",
              },
              {
          ...
          <div class="grid lg:grid-cols-3 gap-6">
            ...
            >
              <h3 class="font-bold mb-5" style={{ color: "#0F172A" }}>
                Ventas por período
              </h3>
              <div style={{ height: "230px" }}>
                <InteractiveBarChart data={ventasMensuales} label="Ventas" />
              </div>
            </div>
            <div
            ...
            >
              ...
              <div style={{ height: "180px" }}>
                <InteractivePieChart data={categorias} />
              </div>
              <div class="space-y-2 mt-3">
                {categorias.map((c) => (
                  <div key={c.label} class="flex items-center justify-between">
                    ...
                    <div class="flex-1">
                      ...
                      >
                        <div
                          ...
                          style={{
                            width: `${(p.vendidos / maxVendidos) * 100}%`,
                            background:
                              i === 0
                                ? "#38BDF8"
                                : i === 1
